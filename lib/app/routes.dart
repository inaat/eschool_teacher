...
import 'package:eschool_teacher/ui/screens/assessment/AssessmentScreen.dart';
import 'package:eschool_teacher/ui/screens/noticeBoardScreen.dart';
...
import 'package:eschool_teacher/ui/screens/routine/RoutineResultScreen.dart';
import 'package:eschool_teacher/ui/screens/schoolSelectScreen.dart';
...
import '../ui/screens/custom_result/ExamResultScreen.dart';
...
class Routes {
  ...
  static const String routineResult = "/routineResult";
  ...
  static Route<dynamic> onGenerateRouted(RouteSettings routeSettings) {
    ...
    switch (routeSettings.name) {
      ...
      case school:
        {
          return   SchoolsScreen.route(routeSettings);
              }
      case login:
        {
      ...
      case assessment:
        {
          return AssessmentScreen.route(routeSettings);
        }
      case addResult:
        {
  ...
  return NoticeBoardScreen.route(routeSettings);
      ...
      case examTimeTable:
        ...
        case examResult:
        {
          return ExamResultScreen.route(routeSettings);
        }
        case routineResult:
        {
          return RoutineResultScreen.route(routeSettings);
        }
      default:
        {
