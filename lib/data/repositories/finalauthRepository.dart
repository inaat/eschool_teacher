...
class AuthRepository {
  late String databaseCampusUrl = Hive.box(mainUrlBoxKey).get(mainUrl);
  ...
  Future<void> signOutUser() async {
    try {
      Api.post(
          body: {},
          url: "$databaseCampusUrl${Api.logout}",
          useAuthToken: true);
    } catch (e) {}
    setIsLogIn(false);
    setJwtToken("");
  ...
  Future<Map<String, dynamic>> signInTeacher(
    ...
    try {
      ...
      final result =
          await Api.post(body: body, url: "$databaseCampusUrl${Api.login}", useAuthToken: false);
  ...
  Future<void> changePassword(
    ...
    try {
      ...
      await Api.post(body: body, url: "$databaseCampusUrl${Api.changePassword}", useAuthToken: true);
    } catch (e) {
      throw ApiException(e.toString());
    }
  }
  ...
  Future<void> forgotPassword({required String email}) async {
    try {
      ...
      await Api.post(body: body, url: "$databaseCampusUrl${Api.forgotPassword}", useAuthToken: false);
    } catch (e) {
      throw ApiException(e.toString());
    }
  }
