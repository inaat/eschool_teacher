...
class TeacherRepository {
  ...
  Future<List<Subject>> subjectsCustomByClassSection(
  ...
  Future<void> submitAssessment(
      {required int studentId,       required List<Map<String, dynamic>> assessmentData}) async {
     try {

    //for (var i = 0; i < assessment.length; i++) {
    //}
    await Api.post(url: Api.submitAssessment, useAuthToken: true, body: {
