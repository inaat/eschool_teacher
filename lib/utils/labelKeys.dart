...
const String fileDownloadKey = "fileDownload";
...
const String myClassesKey = "myClasses";
...
const String addAssessmentKey = "addAssessment";
...
const String latestNoticesKey = "latestNotices";
const String viewAllKey = "viewAll";
const String noticeBoardEmptyKey = "noticeBoardEmpty";
const String noticeBoardKey = "noticeBoard";

const String assessmentSubmittedSuccessfullyKey =
    "assessmentSubmittedSuccessfully";
const String  totalMarksKey = "totalMarks";
const String  totalMarksRequired = "totalMarksRequired";
const String  testMarksShouldGreaterThanZero = "testMarksShouldGreaterThanZero";
const String  addRoutineTest = "addRoutineTest";
